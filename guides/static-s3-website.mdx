---
title: Static next.js website on S3 using terraform and github actions (WIP)
date: "November 3, 2022"
description: Detailed guide to creating a static website on S3. In this example we will be using Next.js, terraform and github actions to do so, and CloudFront to serve the application.
---
...
git branch -M main <- this is to rename the branch, don’t need to run it
...
Copy the distribution domain name into the url and see your application
Image
